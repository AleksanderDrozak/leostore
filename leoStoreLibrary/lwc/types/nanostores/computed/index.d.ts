 ...
 * ```
 */
export function computed<Value extends any, OriginStores extends AnyStore[]>(
  stores: [...OriginStores],
  cb: (...values: StoreValues<OriginStores>) => Value
): ReadableAtom<Awaited<Value>>;
export function computed<Value extends any, OriginStore extends Store>(
  stores: OriginStore,
